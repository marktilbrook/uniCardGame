...
public class CardCraftEngineStudent implements CardCraftInterface
{
    ...
    private Set<Player> allPlayers ; // people who have played sorted by sc 
    private List<Match>  allMatches ;
    private Set<Card>   allKnownCards ;
    ...
    { 
        ...
        this.allPlayers = new TreeSet<>(Comparator.comparing(Player::getWinRatio));// people who have played sorted by sc 
        this.allMatches    = new LinkedList<>() ;
        this.allKnownCards = new HashSet<Card>();
        this.allKnownDecks = new HashSet<Deck>(); 
    }
    ...
    * @param plyrs 
    */
   public void sortPlayersByWinRatio(   List<Player> plyrs )
   { 
    ...
    { 
       List<Player> plyrs = getAllPlayersAsList() ;  
...
//        }
        ...
        Iterator<Player> setIterator = allPlayers.iterator();
        while(setIterator.hasNext()){
            Player e = setIterator.next();
            if (e.isNameThisPlayer(name)) 
            {
                found = e;
            }
        }
...
//
//            if( player.isNameThisPlayer( name))
//            {
//                found =  true;
//            }  
//        }
    ...
    { 
       return  new LinkedList<>( allPlayers );
    }
    //---------------------------------------------------------------------------
    /**
    ...
    { 
        CardCraftEngineStudent engine = new CardCraftEngineStudent("W17006267"); 
        try 
        {
